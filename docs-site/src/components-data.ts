...
export const components: ComponentItem[] = [
    ...
    },
    {
        ...
        category: "forms",
        description:
            "Searchable dropdown with controlled query/value, async option search, form association and keyboard/outside dismissal.",
        status: "stable",
        props: [
            "options",
            "value",
        ...
        usage: {
            wc: `<aui-combobox id="my-combo" name="provider" placeholder="Search provider..."></aui-combobox>\n<script>\nconst combo = document.querySelector('#my-combo');\ncombo.search = async (query, { signal }) => fetch('/api/providers?q=' + encodeURIComponent(query), { signal }).then(r => r.json());\n</script>`,
            react: `import { AdminCombobox } from '@chaos_team/blbui-react'\n\n<AdminCombobox\n  options={providerOptions}\n  query={query}\n  onQueryChange={setQuery}\n  onSearch={searchProviders}\n  onChange={handleSelect}\n/>`,
            vue: `<AdminCombobox :options="providerOptions" v-model:value="provider" v-model:query="query" :search="searchProviders" />`,
  ...
  <aui-form-item label="Channel name" required><aui-input name="channel"></aui-input></aui-form-item>
    ...
    {
        id: "markdown-editor",
        tag: "aui-markdown-editor",
        name: "Markdown Editor",
        category: "business",
        description:
            "Dependency-free Markdown editor with safe preview, form association and controlled value events.",
        status: "stable",
        props: [
            "value",
            "name",
        ...
        events: ["aui-input", "aui-change"],
        previewHtml: `<div style="width:100%;"><aui-markdown-editor id="preview-markdown-editor" value="# Release notes\n\n**Ready** for the next rollout." rows="5"></aui-markdown-editor></div>`,
        usage: {
            wc: `<aui-markdown-editor name="notes" value="# Notes" preview></aui-markdown-editor>`,
            react: `import { AdminMarkdownEditor } from '@chaos_team/blbui-business-react'\n\n<AdminMarkdownEditor value={markdown} preview onChange={setMarkdown} />`,
            vue: `import { registerBusinessElements } from '@chaos_team/blbui-business/register'\n\nregisterBusinessElements()\n\n<aui-markdown-editor :value.prop="markdown" preview @aui-change="saveMarkdown" />`,
            svelte: `<aui-markdown-editor bind:value={markdown} preview on:aui-change={saveMarkdown}></aui-markdown-editor>`,
        },
    },
    {
        id: "markdown-viewer",
        tag: "aui-markdown-viewer",
        name: "Markdown Viewer",
        category: "business",
        description: "Read-only Markdown renderer using a constrained, dependency-free serializer.",
        status: "stable",
        props: ["value", "label", "empty-label"],
        events: [],
        previewHtml: `<div style="width:100%;"><aui-markdown-viewer id="preview-markdown-viewer" value="## Deployment\n\n- Signed\n- Audited"></aui-markdown-viewer></div>`,
        usage: {
            wc: `<aui-markdown-viewer value="## Deployment\n\nReady"></aui-markdown-viewer>`,
            react: `import { AdminMarkdownViewer } from '@chaos_team/blbui-business-react'\n\n<AdminMarkdownViewer value={releaseNotes} />`,
            vue: `<aui-markdown-viewer :value.prop="releaseNotes"></aui-markdown-viewer>`,
            svelte: `<aui-markdown-viewer value={releaseNotes}></aui-markdown-viewer>`,
        },
    },
    {
        id: "rich-text-editor",
        tag: "aui-rich-text-editor",
        name: "Rich Text Editor",
        category: "business",
        description:
            "Controlled rich-text HTML editor with a whitelist sanitizer and safe preview.",
        status: "beta",
        props: [
            "value",
            "name",
        ...
        events: ["aui-input", "aui-change"],
        previewHtml: `<div style="width:100%;"><aui-rich-text-editor id="preview-rich-text-editor" value="&lt;p&gt;Safe &lt;strong&gt;rich text&lt;/strong&gt; preview.&lt;/p&gt;" rows="5"></aui-rich-text-editor></div>`,
        usage: {
            wc: `<aui-rich-text-editor name="content" value="&lt;p&gt;Hello&lt;/p&gt;" preview></aui-rich-text-editor>`,
            react: `import { AdminRichTextEditor } from '@chaos_team/blbui-business-react'\n\n<AdminRichTextEditor value={html} allowImages onChange={setHtml} />`,
            vue: `<aui-rich-text-editor :value.prop="html" allow-images @aui-change="saveHtml" />`,
            svelte: `<aui-rich-text-editor bind:value={html} allow-images on:aui-change={saveHtml}></aui-rich-text-editor>`,
        },
    },
];

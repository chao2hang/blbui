...
root.innerHTML = `
  <aside class="docs-sidebar" id="docs-sidebar">
    ...
    <div class="sidebar-footer"><span class="pulse"></span><span>CORE STATUS / STABLE</span><span class="version">v0.0.5</span></div>
  </aside>
  <div class="docs-main">
    ...
    <main class="docs-content">
      <section class="docs-hero" id="overview">
        <div class="hero-kicker"><span></span> OBSIDIAN INDUSTRIAL CONSOLE / 0.0.5</div>

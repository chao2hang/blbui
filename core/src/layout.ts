...
export class AdminStatElement extends AdminElement {
    ...
    trend = "";
    tone = "";
    private static readonly TONES = ["success", "danger", "warning", "info"];
    render() {
        const tone = AdminStatElement.TONES.includes(this.tone) ? this.tone : "";
        return html`<div class="stat">
            <div class="label">${this.label}</div>
            <div class="value" data-tone=${tone || undefined}>

...
export class AdminAdvancedTableElement extends AdminElement {
    ...
    render() {
        ...
        if (this.loading)
            content = html`<div class="state" role="status" aria-live="polite">LOADING...</div>`;
        else if (this.error)
            content = html`<div class="state" role="alert">
                ${this.errorLabel}
                <div>
                    <slot name="retry"
            ...
            content = html`<div class="state permission" role="status">
